  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: FirebaseOptions(
        apiKey: "AIzaSyBg2n3v2OcLNGRlBNa_RRPo8GlycpqRtfo",
        appId: "1:948401729805:web:ef8f5316a84dfb2c8f4044",
        messagingSenderId: "948401729805",
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // before the use bloc it  intialiase as below
    return BlocProvider(
